                ...
                <div className="md:flex">
                  ...
                  <div className="p-6 md:w-1/2">
                    ...
                    <div className="flex items-center mt-2">
                      ...
                      <span className="text-gray-700">{boat.rating} ({boat.reviews} reviews)</span>
                    ...
                    <div className="mt-6">
                      ...
                      <ul className="mt-2 grid grid-cols-2 gap-2">
                        <li className="text-gray-600">Length: {boat.length}ft</li>
                        <li className="text-gray-600">Capacity: {boat.capacity} people</li>
                        <li className="text-gray-600">Cabins: {boat.cabins}</li>
                        <li className="text-gray-600">Bathrooms: {boat.bathrooms}</li>
                      </ul>
                    </div>
                    ...
                    <div className="mt-8 bg-gray-50 p-4 rounded-lg">
                      <div className="flex justify-between">
                        <div>
                          <span className="text-2xl font-bold text-gray-800">${boat.pricePerDay}</span>
